...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open(file_path, 'r') as json_file:
            ...
            Region.objects.bulk_create(regions)  # Save regions before creating related objects
            ...
            Province.objects.bulk_create(provinces)  # Save provinces before creating related objects
            ...
            for region_code, region_data in data.items():
                ...
                province_list = region_data['province_list']
                for province_name, province_data in province_list.items():
                    province = Province.objects.get(province_name=province_name, region=region)
            ...
            City.objects.bulk_create(cities)  # Save cities before creating related objects
            ...
            for region_code, region_data in data.items():
                ...
                for province_name, province_data in province_list.items():
                    ...
                    municipality_list = province_data['municipality_list']
                    for municipality_name, municipality_data in municipality_list.items():
                        city = City.objects.get(city_name=municipality_name, province=province)
