                    ...
                    <div className="p-6.5">
                        ...
                        <div className="mb-4.5 px-12 py-5">
                            <div className="mb-5">
                                <label
                                    ...
                                    Have you been employed immediately 6 months
                            ...
                            <div>
                                <label
                                    ...
                                    Do you think your getting jobs related to
                                    your experience, skills and knowledge
                                    learned in Dalubhasaan ng Lungsod ng Lucena?
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="modal" role="dialog">
                            <div className="modal-box">
                                ...
                                <p className="py-4">
                                    Are you sure want to submit this entry?
                                </p>
