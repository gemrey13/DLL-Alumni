    ...
    <>
      <div className="navbar text-white sticky top-0 w-full md:px-9 sm:px-0 z-99 bg-gradient-to-r from-slate-800 via-slate-900 to-slate-950">
        <div className="navbar-start">
              ...
              {user && (
                <li className="py-2">
                  ...
                  <ul className="px-3 py-4 shadow bg-black rounded-box w-52">
                    ...
                    <li>
                      <NavLink to="/u/job-application">Job Application</NavLink>
                    </li>
                  </ul>
                </li>
              )}
          ...
          <Link
            to={user ? "/u/" : "/"}
            className="btn-ghost btn lg:text-xl  text-white align-middle lg:flex text-base">
            {" "}
            <img
              src={icon_alumni}
              alt="Icon Alumni"
        ...
        <div className="navbar-end">
          {user ? (
            ...
            <>
              ...
              <NavLink
                to="/auth/signup"
                className="hidden md:inline-flex btn btn-ghost btn-sm text-white">
                Register
              </NavLink>
            </>
          )}
