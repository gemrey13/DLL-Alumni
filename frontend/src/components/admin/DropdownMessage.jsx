...
import UserTwo from '../../images/admin/user/user-02.png';
import UserThree from '../../images/admin/user/user-03.png';
import UserFour from '../../images/admin/user/user-04.png';
...
const DropdownMessage = () => {
  ...
  return <li className="relative" x-data="{ dropdownOpen: false, notifying: true }">
      <Link ref={trigger} onClick={() => setDropdownOpen(!dropdownOpen)} className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white" to="#">
