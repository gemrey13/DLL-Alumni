...
import EmploymentType from "../../components/charts/EmploymentType.jsx";
    ...
    <>
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
          <CardOne
            data={metrics.employed_alumni}
            percentage={metrics.percentage_jobs}
            error={error}
          />
          <CardTwo
            data={metrics.relevant_job}
            percentage={metrics.percentage_relevant}
            error={error}
          />
          <CardThree
            data={metrics.promoted_alumni}
            percentage={metrics.percentage_promoted}
            error={error}
          />
          <CardFour
            data={metrics.alumni_profiles}
            percentage={metrics.percentage_alumni}
            error={error}
          />
        </div>
      )}
