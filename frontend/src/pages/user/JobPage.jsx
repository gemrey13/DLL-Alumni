    ...
    <>
                ...
                <label
                  ...
                  <div className="relative">
                    ...
                    <div
                      ...
                      <span
                        className={`opacity-0 ${entryLevel && "!opacity-100"}`}>
                        <svg
                          width="11"
                          height="8"
                          viewBox="0 0 11 8"
              ...
              <div className="mb-2">
                <label
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={`mr-4 flex h-6 w-6 items-center justify-center rounded border-gray-500 border ${
                        expert && "border-primary bg-gray dark:bg-transparent"
                      }`}>
                      <span className={`opacity-0 ${expert && "!opacity-100"}`}>
                        <svg
                          width="11"
                          height="8"
                          viewBox="0 0 11 8"
      ...
      <div className="flex h-full flex-col md:flex-row">
        <aside className="w-full md:w-72.5 lg:block hidden">
          <h4 className="text-lg text-black font-medium mt-8 mb-3">Category</h4>
          <select
          ...
          <div className="mb-2">
            <label
              ...
              <div className="relative">
                ...
                <div
                  className={`mr-4 flex h-6 w-6 items-center justify-center rounded border-gray-500 border ${
                    entryLevel && "border-primary bg-gray dark:bg-transparent"
                  }`}>
                  <span className={`opacity-0 ${entryLevel && "!opacity-100"}`}>
                    <svg
                      width="11"
                      height="8"
                      viewBox="0 0 11 8"
          ...
          <div className="mb-2">
            <label
              ...
              <div className="relative">
                ...
                <div
                  className={`mr-4 flex h-6 w-6 items-center justify-center rounded border-gray-500 border ${
                    intermediate && "border-primary bg-gray dark:bg-transparent"
                  }`}>
                  <span
                    className={`opacity-0 ${intermediate && "!opacity-100"}`}>
                    <svg
                      width="11"
                      height="8"
                      viewBox="0 0 11 8"
          ...
          <h4 className="text-lg text-black font-medium mt-8 mb-3">Job type</h4>
          <select
            {...register("Job_type")}
            className="select select-sm border-gray-400 w-full max-w-xs">
            <option value="">Select Job Type</option>
